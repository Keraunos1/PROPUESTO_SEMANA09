...
public class Propuesto_09_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnAdicionar(ActionEvent arg0) {
		...
		Factura nueva = new Factura(ruc, empresa, unidades, precioUnitario);
		af.adicionar(nueva);
		listar();
		limpieza();
	}
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("Suma importes facturados : "+ af.sumaImportes());
		imprimir("Importe promedio facturado : "+ af.importePromedioFacturado());
		imprimir("Menor importe facturado : "+ af.menorImporteFacturado());
		imprimir("Mayor importe facturado : "+ af.mayorImporteFacturado());
		imprimir("Empresa menor al promedio fac : "+ af.empresaMenorAlimportePromedioFac());
